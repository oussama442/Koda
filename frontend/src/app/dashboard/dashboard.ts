...
@Component({
  ...
  template: `
    <div class="space-y-8">
      <!-- Welcome Card -->
      <div class="koda-card p-10 bg-linear-to-br from-white to-blue-50 border-blue-100 text-center">
         <h2 class="text-3xl font-black mb-4">Good morning, {{ user?.full_name }}! 👋</h2>
         <p class="text-gray-500 max-w-2xl leading-relaxed mx-auto">The dashboard is currently under construction, but your authentication is working perfectly. You are logged in as an <strong>{{ user?.is_global_admin ? 'Administrator' : 'User' }}</strong>.</p>
      </div>

      <!-- Stats Grid -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="koda-card p-8 bg-white hover:border-blue-200 transition-all text-center">
